        ...
        <div class="md:max-w-full flex justify-center  ">
            <table class="bg-white shadow even:bg-gray-300 rounded">
                ...
                @forelse($genres as $genre)
                    <tr>
                        <td class="w-3/5 text-left py-3 px-4"><a href="{{ route('book.genre', $genre->id) }}">{{ $genre->title }}</a></td>
                        <td class="w-1/5 text-left py-3 px-4"><a href="{{ route('admin.genre.edit', $genre->id )}}"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                                                                                                           width="20" height="20"
                                                                                                                           viewBox="0 0 40 40"
                        ...
                        <td class="w-1/5 text-left py-3 pl-7"><a href="{{ route('admin.genre.edit', $genre->id )}}"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                                                                                                           width="25" height="25"
                                                                                                                           viewBox="0 0 100 100"
