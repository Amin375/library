...
@section('content')
    <div class="flex justify-center mt-2.5 gap-x-4 px-2">
        ...
        <button
            ...
            id="switch-button">
                <span id="btn-switch-images" class="inline"><svg xmlns="http://www.w3.org/2000/svg" version="1.0"
                                                                 width="23" height="23"
                        ...
                        <tr>
                            <td class="md:w-5/12 lg:w-5/12 xl:w-5/12 2xl:w-5/12 text-left py-3 px-3">
                                <div class="flex justify-between">
                                    ...
                                    <div class="inline-flex md:hidden lg:hidden xl:hidden 2xl:hidden">
                                        ...
                                        <div class="px-3"><a href="{{ route('admin.book.edit', $book->id )}}">
                                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                                    ...
                                                    <path fill="#36404d"
                                                          d="M3.805 33.13L1.504 38.5 6.888 36.201z"></path>
                                                    <path fill="#f78f8f"
                                        ...
                                        <div class="px-3 "><a href="{{ route('admin.book.destroy', $book->id )}}"
                            ...
                            <td class="hidden md:inline-flex lg:inline-flex xl:inline-flex 2xl:inline-flex justify-end  md:w-6/12 lg:w-6/12 xl:w-6/12 2xl:w-6/12  p-3 pr-10">
                                <div class="flex justify-evenly gap-x-9">
                                    ...
                                    <div class=""><a href="{{ route('admin.book.edit', $book->id )}}">
                                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                                 width="20" height="20"
                                                 viewBox="0 0 40 40"
                                                 style=" fill:#000000;">
                                    ...
                                    <div class=""><a href="{{ route('admin.book.destroy', $book->id )}}"
                                                     onclick="return confirm('Are you sure you want to delete {{ $book->title }} from {{ $book->author->name }}?')">
                                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                                 width="25" height="25"
                                                 viewBox="0 0 100 100"
