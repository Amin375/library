                ...
                @forelse($books as $book)
                    <tr>
                        <td class="w-1/3 text-left py-3 px-3">
                            <div class="flex justify-between">
                                ...
                                <div class="inline-flex md:hidden lg:hidden xl:hidden 2xl:hidden">
                                    <a class="hover:bg-gray-200 active:bg-gray-300 rounded-xl p-3 -mt-1.5"
                                    ...
                                    <a class="text-lg hover:bg-gray-200 active:bg-gray-300 rounded-xl p-3 -mt-1.5"
                        ...
                        <td class="hidden md:table-cell lg:table-cell xl:table-cell 2xl:table-cell ">
                            <div class="flex justify-evenly gap-x-9 pl-5">
                                ...
                                <a class="text-lg hover:bg-gray-200 active:bg-gray-300 rounded-xl p-2 mt-1"
                                   href="{{ route('loans.cart.destroy', $book->id )}}">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                         width="25" height="25"
                                         viewBox="0 0 100 100"
