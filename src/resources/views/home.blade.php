    ...
    <main class="sm:container sm:mx-auto sm:mt-10">
        ...
        <div
            ...
            @foreach($books as $book)
                            ...
                            <div class="col-span-8">
                                ...
                                <div class="mt-7 flex flex-col align-between">
                                    ...
                                    <a href="{{ route('book.show', ['slug' => $book->slug]) }}"
                                       class="px-4 w-1/3 py-2 bg-blue-800 text-center text-white rounded-xl hover:bg-blue-900">Read
                                        More</a>
                                </div>
                            </div>
                        </div>
                ...
                @endif
                @if($loop->iteration > 3)
                    <div class="col-span-3 p-5 border border-gray-500 rounded-md shadow-md mb-10">
                        <div class="grid lg:grid-cols-12 xl:grid-cols-12 2xl:grid-cols-12 gap-x-3">
                            <div class="col-span-6">
                                <img class="rounded-md shadow-lg h-60 w-52" src="{{ secure_asset($book->image()) }}"
                                     alt="{{ $book->title }} ">
                            </div>
                            <div class="col-span-6 grid content-between">
