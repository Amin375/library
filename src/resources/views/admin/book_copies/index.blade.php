...
@section('content')
    <div class="flex px-5 sm:px-10 md:px-10 lg:px-20  xl:px-10  2xl:px-10
            ...
            <table class="min-w-full bg-white">
                ...
                <span class="px-2 inline-flex text-md leading-5 rounded-full text-gray-900">
                  {{ $book->genre->title }}
                        ...
                        <td class="px-3 py-2 leading-5 whitespace-nowrap text-md text-gray-900 flex justify-evenly">
                            <a class="text-3xl"
