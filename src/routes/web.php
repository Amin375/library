...
Route::get('dashboard/edit/{user}', [DashboardController::class, 'edit'])->name('dashboard.edit')->middleware('auth');
...
Route::get('books/genre/{id}', [BookGenreController::class, 'index'])->name('book.genre')->middleware('auth');
Route::get('books/author/{id}', [BookAuthorController::class, 'index'])->name('book.author')->middleware('auth');
